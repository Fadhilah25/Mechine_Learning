...
fadhil = Siswa("14130", "Fadhil", "Semarang")
valen = SiswaSMK("14128", "Valen", "Kudus", "Rekayasa Perangkat Lunak")

## tambah nilai ( Disini kita memasukan nama dari mata pelajaran / mata kuliah dan nilai dari mata kuliah/pelajaran tersebut)
fadhil.tambahNilai("Matematika", 98)
fadhil.tambahNilai("IPA", 95)
fadhil.tambahNilai("Bahasa Inggris", 100)

fadhil.tampilkan()

valen.tambahNilai("Pemrograman Web", 100)
valen.tambahNilai("Networking 1", 100)
valen.tambahNilai("Otomata", 80)
valen.tampilkan()

#fadhil.tampilkanNilai()
#fadhil.tampilkanRataNilai()
#valen.tampilkan()
...
bniFadhil.kredit(1000)
bniFadhil.cetakSaldo()
bniFadhil.debit(100000)
...
m1 = Manager(1234,"Dhani","Fadhil",5000,9000)
print(m1.getName())
print(m1.getAnnualSalary())

# e1 = Employee(1234,"Dhani","Fadhil",5000)
# print(e1.getSalary())
