...
perkenalan("Fadhilah","Aditya")
perkenalan("Callysta","Maura")

print()

perkenalan(namaDepan = "Fadhilah2", namaBelakang = "Aditya2")
...
introduction(firstName="Fadhilah")
introduction(firstName="Fadhilah", lastName="Aditya")
introduction("Fadhilah", lastName="Aditya")
...
#Call the Function here
introductionLengkap(firstName="Fadhilah", lastName="Aditya", middleName="Prabowo")
